...
export const modpackVersion = sqliteTable("modpack_version", {
  id: text("id").primaryKey(),
  version: text("version").notNull(),
  modConfigsUrl: text("mod_configs_url"),
  modsString: text("mods_string"),
...
export const modpackRelations = relations(modpack, ({ one, many }) => ({
  user: one(user, {
    fields: [modpack.owner],
    references: [user.id],
  }),
